                  ...
                  <ul className="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                      <li className="nav-item dropdown">
                          ...
                          <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                              <li><a className="dropdown-item" href="./pages/productOverviewPage/productOverview.html">All
                                      products</a></li>
                              <li>
                                  <hr className="dropdown-divider" />
                              </li>
                              <li><a className="dropdown-item" href="./pages/productOverviewPage/erhvervOverview.html">Professions</a>
                              </li>
                              <li><a className="dropdown-item" href="./pages/productOverviewPage/fastelavnOverview.html">Carnival</a>
                              </li>
                              <li><a className="dropdown-item" href="./pages/productOverviewPage/diverseOverview.html">Various ducks</a>
                              </li>
                          </ul>
                      </li>
                      <form action="https://en.wikipedia.org/wiki/Rubber_duck" className="d-flex">
                          <button className="about-btn btn YellowButton" type="submit" id="about-btn">
